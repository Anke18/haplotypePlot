 ...
 * @LastEditTime: 2020-07-06 16:29:36
 */
...
export const getFreUrl2 = (cnt) => {

    let furl = "https://bigd.big.ac.cn/ncov/rest/variation/haplotype/json?date=freq&area=nodesVariant&frequency="+cnt;
    //console.log(furl);
    return furl;
}