 ...
 * @LastEditTime: 2020-06-18 15:19:55
 */
...
import { setCountryCoord, drawMap, drawMapL, drawCircle } from './mapPlot';
...
import { getFreUrl } from "./getDataUrl";
import 'jquery';
//import 'jquery-ui';
...
function setting () {
    ...
    let nodeScale = setScale("sqrt", nodeExtent, [1, 12])
    let linkScale = setScale("sqrt", linkExtent, [15, 200])
